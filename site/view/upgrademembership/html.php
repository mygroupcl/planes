...
class OSMembershipViewUpgradeMembershipHtml extends MPFViewHtml
{
	...
	public function display()
	{
		...
		if (!$user->id)
		{
			...
			if ($option == 'com_osmembership' && $view == 'upgrademembership')
			{
			...
			$app->redirect(JRoute::_('index.php?option=com_users&view=login&return=' . base64_encode($returnUrl), false), JText::_('OSM_LOGIN_TO_UPGRADE_MEMBERSHIP'));
		}
