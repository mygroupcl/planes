...
class OSMembershipViewProfileHtml extends MPFViewHtml
{
	public function display()
	{
		...
		if (!$user->id)
		{
			...
			if ($option == 'com_osmembership' && $view == 'profile')
			{
			...
			$app->redirect(JRoute::_('index.php?option=com_users&view=login&return=' . base64_encode($returnUrl), false), JText::_('OSM_LOGIN_TO_EDIT_PROFILE'));
		}
